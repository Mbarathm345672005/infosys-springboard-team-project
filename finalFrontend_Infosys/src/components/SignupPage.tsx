...
import { BookOpen, Eye, EyeOff, GraduationCap, CheckCircle2, XCircle } from 'lucide-react';
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <Card className="backdrop-blur-xl bg-white/95 shadow-xl border-white/60">
          <CardHeader className="space-y-1 pb-6">
            <CardTitle className="text-2xl text-center text-slate-800">Create an account</CardTitle>
            <CardDescription className="text-center text-slate-600">
              Join NoteMate and start sharing notes
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <div className="space-y-2">
                ...
                {password && (
                  <div className="flex items-center gap-2 mt-2">
                    ...
                    <span className={`text-sm ${hasMinLength ? 'text-green-600' : 'text-red-600'}`}>
